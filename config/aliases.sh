...
function __print_help() {
    ...
    echo -e "    ${GREEN}mksync${NC}           : One-step init (mkenv + uvs + sync_deps + cb + s)"
    ...
    echo -e "    ${GREEN}mkenv${NC} / ${GREEN}activate${NC} : Create & Activate python venv in /workspace/install"
    echo -e "    ${GREEN}uvs${NC} / ${GREEN}uvr${NC}        : uv sync / uv run"
    echo -e "    ${GREEN}uvp${NC} / ${GREEN}uvl${NC}        : uv pip install / list"
    echo -e "    ${GREEN}pyv${NC} / ${GREEN}uvpython${NC}   : Show Python/uv versions / List uv pythons"
